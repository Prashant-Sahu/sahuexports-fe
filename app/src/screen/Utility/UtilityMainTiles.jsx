  ...
  const checkSessionData = async (blockId) => {
    ...
    if (access != null) {
      ...
      if (blockId == "LocalSalesApproval") {
        ...
        blockId == "Dashboard" &&
        accDetails.filter((f) => f.appCode == 801)[0].permission == 1
      ) {
        routerN.push("/src/screen/Dashboard/DashboardMenu");
      } else if (
        blockId == "MISReport" &&
        accDetails.filter((f) => f.appCode == 802)[0].permission == 1
      ) {
      ...
      >
        ...
        >
          <View style={styles.grdRow}>
            ...
            <TouchableOpacity
              onPress={() => handledashboardMenu("PngReading")}
            ...
            >
              <View style={styles.linearGradient}>
                ...
                >
                  <Text style={[styles.buttonText]} numberOfLines={1}></Text>
                </View>
              </View>
            </TouchableOpacity>
          </View>
